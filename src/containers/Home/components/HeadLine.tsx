...
const HeadLine = ({ isSeparate = true, title }: HeadlineProps) => {
  return (
    <div className="mt-10 text-white mb-5 flex-between flex-wrap gap-4">
      ...
      <h2 className="relative text-xl lg:text-2xl font-extrabold ml-4">
        {title}
      ...
      <Link
        href={"/"}
        className="py-1 px-3 bg-secondary text-xs font-medium hover:opacity-80 transition-base ml-auto rounded-sm"
      >
        XEM THÊM
      </Link>
    </div>
